...
```vue
<UIcon name="lucide:sun" class="size-5" />
<UButton icon="lucide:plus" label="Add" />
<UAlert icon="lucide:info" title="Heads up" />
```
...
toast.add({ title: 'Saved', color: 'success', icon: 'lucide:check' })
